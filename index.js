...
const sketch = (p) => {
    ...
    let reverb, compressor, reverbWetGain;
    let audioStarted = false;
    let font;
    let uiLayer; // Off-screen buffer for 2D UI elements
    let gui; // Declare gui in sketch scope to access it in mouseClicked
     ...
     */
    function setSynthWaveform(synth, waveform) {
